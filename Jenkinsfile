    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                sh """
                mvn sonar:sonar \
                  -Dsonar.projectKey=SonarQube-plus \
                  -Dsonar.host.url=http://54.247.234.149:9000 \
                  -Dsonar.login=0cfad259e77a3d7f194904f5ba7f19f7a6b90296
